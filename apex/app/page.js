...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      <p className="text-center">I&apos;m currently studying (<InnerLink url="https://www.isen.fr/" text="ISEN" /> & <InnerLink url="https://www.uqac.ca/" text="UQAC" />) and seeking <InnerLink url="/resume.pdf" text="an internship" /></p> 
    </div>
  );
}
